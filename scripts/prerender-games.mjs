...
const GAME_META = {
  DinoJump: {
    en: { title: "New Dino Jump", description: "The rules aren't what you remember. Work out what's actually dangerous — before it's too late." },
    zh: { title: "新恐龙跳", description: "规则已经不是你熟悉的那套。摸索出真正危险的是什么，才能活下去。" },
    fr: { title: "Nouveau Dino Jump", description: "Les règles ne sont plus les mêmes. Découvrez ce qui est vraiment dangereux — avant qu'il ne soit trop tard." },
    de: { title: "Neues Dino Jump", description: "Die Regeln sind nicht mehr dieselben. Finde heraus, was wirklich gefährlich ist — bevor es zu spät ist." },
    es: { title: "Nuevo Dino Jump", description: "Las reglas ya no son las mismas. Descubre qué es realmente peligroso — antes de que sea tarde." },
    ja: { title: "新ダイノジャンプ", description: "ルールはもう同じじゃない。何が本当に危険なのか見極めろ——手遅れになる前に。" },
    ko: { title: "새로운 다이노 점프", description: "규칙이 예전과 다릅니다. 진짜 위험한 게 뭔지 알아내세요 — 늦기 전에." },
    pt: { title: "Novo Dino Jump", description: "As regras não são mais as mesmas. Descubra o que é realmente perigoso — antes que seja tarde." },
    ru: { title: "Новый Dino Jump", description: "Правила уже не те. Разберитесь, что на самом деле опасно — пока не поздно." },
    ar: { title: "داينو جامب الجديد", description: "القواعد لم تعد كما كانت. اكتشف ما هو خطير حقًا — قبل فوات الأوان." },
    hi: { title: "नया डायनो जंप", description: "नियम अब वैसे नहीं हैं। पता लगाएं कि असल में खतरनाक क्या है — देर होने से पहले।" },
  },
  Tetris: {
    en: { title: "New Tetris", description: "No line clears here. Figure out what actually scores — the real rule is hidden." },
    zh: { title: "新俄罗斯方块", description: "这里不消行。摸索出到底靠什么得分——真正的规则被藏起来了。" },
    fr: { title: "Nouveau Tetris", description: "Pas de lignes à effacer ici. Découvrez ce qui compte vraiment — la vraie règle est cachée." },
    de: { title: "Neues Tetris", description: "Hier werden keine Reihen geräumt. Finde heraus, was wirklich zählt — die echte Regel ist versteckt." },
    es: { title: "Nuevo Tetris", description: "Aquí no se eliminan líneas. Descubre qué es lo que realmente puntúa — la regla real está oculta." },
    ja: { title: "新テトリス", description: "ここではラインは消えない。何で得点するのか見極めろ——本当のルールは隠されている。" },
    ko: { title: "새로운 테트리스", description: "여기선 줄이 지워지지 않습니다. 무엇이 점수가 되는지 알아내세요 — 진짜 규칙은 숨겨져 있습니다." },
    pt: { title: "Novo Tetris", description: "Aqui não há eliminação de linhas. Descubra o que realmente pontua — a regra real está escondida." },
    ru: { title: "Новый Тетрис", description: "Линии здесь не убираются. Разберитесь, что приносит очки — настоящее правило скрыто." },
    ar: { title: "تتريس الجديد", description: "لا يتم مسح الصفوف هنا. اكتشف ما الذي يمنحك النقاط فعلاً — القاعدة الحقيقية مخفية." },
    hi: { title: "नया टेट्रिस", description: "यहाँ लाइनें साफ़ नहीं होतीं। पता लगाएं कि असल में अंक किससे मिलते हैं — असली नियम छिपा है।" },
  },
  SnakeOrbit: {
    en: { title: "New Snake", description: "Same snake, different rules. Figure out how you actually win — before you crash." },
    zh: { title: "新贪吃蛇", description: "还是那条蛇，规则却变了。摸索出获胜的关键，撞上去之前想明白。" },
    fr: { title: "Nouveau Snake", description: "Même serpent, règles différentes. Découvrez comment gagner vraiment — avant de vous écraser." },
    de: { title: "Neues Snake", description: "Gleiche Schlange, andere Regeln. Finde heraus, wie man wirklich gewinnt — bevor du abstürzt." },
    es: { title: "Nuevo Snake", description: "Misma serpiente, reglas distintas. Descubre cómo ganar de verdad — antes de chocar." },
    ja: { title: "新スネーク", description: "同じヘビ、違うルール。本当の勝ち方を見極めろ——ぶつかる前に。" },
    ko: { title: "새로운 스네이크", description: "같은 뱀, 다른 규칙. 진짜 이기는 방법을 알아내세요 — 부딪히기 전에." },
    pt: { title: "Novo Snake", description: "Mesma cobra, regras diferentes. Descubra como vencer de verdade — antes de bater." },
    ru: { title: "Новая Змейка", description: "Та же змейка, другие правила. Разберитесь, как на самом деле победить — прежде чем врежетесь." },
    ar: { title: "الثعبان الجديد", description: "نفس الثعبان، قواعد مختلفة. اكتشف كيف تفوز فعلاً — قبل أن تصطدم." },
    hi: { title: "नया स्नेक", description: "वही सांप, अलग नियम। पता लगाएं कि असल में कैसे जीतना है — टकराने से पहले।" },
  },
};
